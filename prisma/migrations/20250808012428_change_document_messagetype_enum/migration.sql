...
-- AlterEnum
BEGIN;
CREATE TYPE "MessageType_new" AS ENUM ('text', 'image', 'audio', 'video', 'document', 'location', 'contact');
ALTER TABLE "messages" ALTER COLUMN "type" TYPE "MessageType_new" USING ("type"::text::"MessageType_new");
ALTER TABLE "attachments" ALTER COLUMN "type" TYPE "MessageType_new" USING ("type"::text::"MessageType_new");
